...
class RevenueAnalyser:
    ...
    def get_data_ratio(self, all_data):
        ...
        for data in all_data:
            result = pd.DataFrame()
            result['营业收入'] = data['营业收入'] #get Revenue Account number
    ...
    def Analyse(self, stocks):
        ...
        data_ratio = self.get_data_ratio(data_Dec) #get Revenue Account number
        self.data_plot(data_ratio) # Plot Revenue Account number with respect to time
